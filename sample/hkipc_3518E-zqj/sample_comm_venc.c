...
//extern unsigned int g_VbrMaxQq;
    ...
    switch(enType)
    {
        case PT_H264:
        {
            ...
            if (SAMPLE_RC_CBR == enRcMode)
            {
                ...
                stH264Cbr.u32Gop            = 90;//(VIDEO_ENCODING_MODE_PAL == enNorm)?25:25;
                stH264Cbr.u32StatTime       = 1; /* stream rate statics time(s) */
                stH264Cbr.u32ViFrmRate      = (VIDEO_ENCODING_MODE_PAL == enNorm)?25:25;/* input (vi) frame rate */
            #if (DEV_ROBOT)
                stH264Cbr.fr32TargetFrmRate = 10; //(VIDEO_ENCODING_MODE_PAL == enNorm)?15:15;//25:30;/* target frame rate */
                //printf(".........11111111111\n");
            #else
                stH264Cbr.fr32TargetFrmRate = (VIDEO_ENCODING_MODE_PAL == enNorm)?15:15;//25:30;/* target frame rate */
                //printf("..........22222222222222\n");
            #endif
                switch (enSize)
                {
                    case PIC_QCIF:
                       stH264Cbr.u32BitRate = 32; //256; /* average bit rate */
                       break;                       
                    case PIC_QVGA:    /* 320 * 240 */
                    case PIC_CIF:	
                       stH264Cbr.u32BitRate = 32; //64; //512;
                       break;
                    case PIC_D1:
                    case PIC_VGA:	   /* 640 * 480 */
                       stH264Cbr.u32BitRate = 32; //64; //768;
                       break;
                    case PIC_HD720:   /* 1280 * 720 */
                       stH264Cbr.u32BitRate = 1024;
                       break;
                    case PIC_HD960:   /* 1280 * 960 */
                       stH264Cbr.u32BitRate = 1024;
                       break;
                ...
                printf("[%s, %d] CBR: enRcMode:%d, enNorm:%d, fr32TargetFrmRate:%d, u32BitRate:%d...\n", __func__, __LINE__, enRcMode, enNorm, stH264Cbr.fr32TargetFrmRate, stH264Cbr.u32BitRate);
            }
            else if (SAMPLE_RC_FIXQP == enRcMode) 
            {
                stVencChnAttr.stRcAttr.enRcMode = VENC_RC_MODE_H264FIXQP;
                stH264FixQp.u32Gop            = (VIDEO_ENCODING_MODE_PAL == enNorm)?25:25;
                stH264FixQp.u32ViFrmRate      = (VIDEO_ENCODING_MODE_PAL == enNorm)?25:25;
                stH264FixQp.fr32TargetFrmRate = (VIDEO_ENCODING_MODE_PAL == enNorm)?15:15;//25:30;
            ...
            else if (SAMPLE_RC_VBR == enRcMode) 
            {
                ...
                stH264Vbr.u32Gop            = 90;//(VIDEO_ENCODING_MODE_PAL == enNorm)?25:25;
                stH264Vbr.u32StatTime       = 5;
                stH264Vbr.u32ViFrmRate      = (VIDEO_ENCODING_MODE_PAL == enNorm)?25:25;
            #if (DEV_ROBOT)
                stH264Vbr.fr32TargetFrmRate = 10; //(VIDEO_ENCODING_MODE_PAL == enNorm)?15:15;//25:30;
                //printf("...................333333333333333333\n");
            #else
                stH264Vbr.fr32TargetFrmRate = (VIDEO_ENCODING_MODE_PAL == enNorm)?15:15;//25:30;
                //printf("...................444444444444444444\n");
            #endif
                stH264Vbr.u32MinQp          = 10; //24;
                stH264Vbr.u32MaxQp          = 33; //32;
                //printf("...%s, %d...enSize:%d...\n", __func__, __LINE__, enSize);
                switch (enSize)
                {
                    case PIC_QCIF:
                        stH264Vbr.u32MaxBitRate = 32; //256*3; /* average bit rate */
                        break;
                    case PIC_QVGA:    /* 320 * 240 */
                    case PIC_CIF:
                        stH264Vbr.u32MaxBitRate = 32; //48; //64; //512*3;
                        break;
                    case PIC_D1:
                    case PIC_VGA:	    /* 640 * 480 */
                        stH264Vbr.u32MaxBitRate = 32; //48; //64; //150; //512;
                        break;
                    case PIC_HD720:   /* 1280 * 720 */
                        stH264Vbr.u32MaxBitRate = 200; //150; //512; //1024*3*3;
                        break;
                    case PIC_HD960:   /* 1280 * 960 */
                        stH264Vbr.u32MaxBitRate = 200; //512;
                        break;
                    case PIC_HD1080:  /* 1920 * 1080 */
                        stH264Vbr.u32MaxBitRate = 200; //1024*6*3;
                        break;
                    default :
                        stH264Vbr.u32MaxBitRate = 200; //1024*4*3;
                        break;
                }
                memcpy(&stVencChnAttr.stRcAttr.stAttrH264Vbr, &stH264Vbr, sizeof(VENC_ATTR_H264_VBR_S));
                printf("[%s, %d] VBR: enRcMode:%d, enNorm:%d, fr32TargetFrmRate:%d, u32MaxBitRate:%d...\n", __func__, __LINE__, enRcMode, enNorm, stH264Vbr.fr32TargetFrmRate, stH264Vbr.u32MaxBitRate);
            }
            else
            {
                return HI_FAILURE;
        ...
        case PT_MJPEG:
        {
            ...
            if(SAMPLE_RC_FIXQP == enRcMode)
            {
                ...
                stMjpegeFixQp.u32ViFrmRate      = (VIDEO_ENCODING_MODE_PAL== enNorm)?25:25;
                stMjpegeFixQp.fr32TargetFrmRate = (VIDEO_ENCODING_MODE_PAL== enNorm)?15:15;
            ...
            else if (SAMPLE_RC_CBR == enRcMode)
            {
                ...
                stVencChnAttr.stRcAttr.stAttrMjpegeCbr.u32ViFrmRate      = (VIDEO_ENCODING_MODE_PAL== enNorm)?25:25;
                stVencChnAttr.stRcAttr.stAttrMjpegeCbr.fr32TargetFrmRate = (VIDEO_ENCODING_MODE_PAL== enNorm)?15:15;
                ...
                switch (enSize)
                {
                    ...
                    case PIC_HD720:   /* 1280 * 720 */
                        ...
                        break;
                    case PIC_HD960:   /* 1280 * 960 */
                        stVencChnAttr.stRcAttr.stAttrMjpegeCbr.u32BitRate = 1024*6*3;
                        break;
                    case PIC_HD1080:  /* 1920 * 1080 */
            ...
            else if (SAMPLE_RC_VBR == enRcMode) 
            {
                ...
                stVencChnAttr.stRcAttr.stAttrMjpegeVbr.u32ViFrmRate = (VIDEO_ENCODING_MODE_PAL == enNorm)?25:25;
