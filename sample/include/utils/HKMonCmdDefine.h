...
enum _HK_MON_OPERATION_CODE
{
	...
	HK_MON_GET_APPITME =	 255,	//手机获取列表带访问密码
	HK_MON_APP_CHECK =       256,	//定制APP校对设备
	HK_MON_433_SET =         257,   //配置433报警器信息
	...
	HK_WLSQ_ADD_PUSH_USER=503,	//威视安绑定用户push
	HK_WLSQ_DEL_PUSH_USER=504,	//威视安删除用户push
...
#define HK_KEY_PHONEUSER	 "phUser"		//4G拨号配置
#define HK_KEY_PHONEAPN		 "phApn"		//4G
#define HK_KEY_OPENCLOSE	 "opcl"			//开启关闭
...
#define HK_KEY_ALARM_BEGINE_TIME	"alBeginTime"		//报警开始时间
#define HK_KEY_ALARM_END_TIME		"alEndTime"			//报警结束时间
...
#define HK_KEY_LIGHT			"light"			//灯光开关
#define HK_KEY_ALARMLIGHT		"allight"		//报警灯光开关
#define HK_KEY_SCENE            "scene"			//场景
#define HK_KEY_LIGHTTIME		"lighttime"		//灯光时间控制
...
#define HK_KEY_OPENONVIFAUDIO "openonvifaudio"  //开关设备Onvif 音频
